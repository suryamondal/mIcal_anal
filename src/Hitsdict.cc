//
// File generated by rootcint at Thu Jan  2 19:07:49 2020
...
namespace ROOTDict {
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::Hits*)
   {
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::Hits*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int Hits::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::Hits*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void Hits::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::Hits*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *Hits::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::Hits*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::Hits
...
/* Hits */
static int G__Hitsdict_235_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   Hits* p = NULL;
...
static int G__Hitsdict_235_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   switch (libp->paran) {
   case 2:
...
static int G__Hitsdict_235_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__Hitsdict_235_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const Hits*) G__getstructoffset())->GetHits());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Hitsdict_235_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) Hits::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Hitsdict_235_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Hits::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Hitsdict_235_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) Hits::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Hitsdict_235_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      Hits::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__Hitsdict_235_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__Hitsdict_235_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Hits::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Hitsdict_235_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) Hits::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Hitsdict_235_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Hits::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Hitsdict_235_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__Hitsdict_235_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__Hitsdict_235_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__Hitsdict_235_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarHits(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__HitsdictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncHits(void) {
   ...
   G__memfunc_setup("Hits",408,G__Hitsdict_235_0_1, 105, G__get_linked_tagnum(&G__HitsdictLN_Hits), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("AddHits",673,G__Hitsdict_235_0_2, 85, G__get_linked_tagnum(&G__HitsdictLN_HitPos), -1, 0, 2, 1, 1, 0, 
"f - 'Float_t' 0 - random f - 'Float_t' 0 '1' ptmin", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("ClearTracks",1103,G__Hitsdict_235_0_3, 121, -1, -1, 0, 0, 1, 1, 0, "", "clears previous track objects..", (void*) NULL, 0);
   G__memfunc_setup("GetHits",696,G__Hitsdict_235_0_4, 85, G__get_linked_tagnum(&G__HitsdictLN_TClonesArray), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__Hitsdict_235_0_5, 85, G__get_linked_tagnum(&G__HitsdictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&Hits::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__Hitsdict_235_0_6, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Hits::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__Hitsdict_235_0_7, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&Hits::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__Hitsdict_235_0_8, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&Hits::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__Hitsdict_235_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__Hitsdict_235_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Hits::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__Hitsdict_235_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Hits::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__Hitsdict_235_0_15, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Hits::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__Hitsdict_235_0_16, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Hits::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("Hits", 408, G__Hitsdict_235_0_17, (int) ('i'), G__get_linked_tagnum(&G__HitsdictLN_Hits), -1, 0, 1, 1, 1, 0, "u 'Hits' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Hits", 534, G__Hitsdict_235_0_18, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__Hitsdict_235_0_19, (int) ('u'), G__get_linked_tagnum(&G__HitsdictLN_Hits), -1, 1, 1, 1, 1, 0, "u 'Hits' - 11 - -", (char*) NULL, (void*) NULL, 0);
