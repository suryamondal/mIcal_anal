...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::HitPos*)
   {
      ::HitPos *ptr = 0;
      ...
      static ::ROOT::TGenericClassInfo 
         instance("HitPos", ::HitPos::Class_Version(), "./HitPos.h", 34,
                  typeid(::HitPos), ::ROOT::DefineBehavior(ptr, ptr),
   ...
   ROOT::TGenericClassInfo *GenerateInitInstance(const ::HitPos*)
   {
...
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::HitPos*)0x0)->GetImplFileName();
}

//______________________________________________________________________________
int HitPos::ImplFileLine()
{
   return ::ROOTDict::GenerateInitInstanceLocal((const ::HitPos*)0x0)->GetImplFileLine();
}

//______________________________________________________________________________
void HitPos::Dictionary()
{
   fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::HitPos*)0x0)->GetClass();
}

//______________________________________________________________________________
TClass *HitPos::Class()
{
   if (!fgIsA) { R__LOCKGUARD2(gCINTMutex); if(!fgIsA) {fgIsA = ::ROOTDict::GenerateInitInstanceLocal((const ::HitPos*)0x0)->GetClass();} }
   return fgIsA;
}
...
} // end of namespace ROOTDict for class ::HitPos
...
/* HitPos */
static int G__HitPosdict_234_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   HitPos* p = NULL;
...
static int G__HitPosdict_234_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   HitPos* p = NULL;
   char* gvp = (char*) G__getgvp();
   //m: 1
...
static int G__HitPosdict_234_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) HitPos::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__HitPosdict_234_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HitPos::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__HitPosdict_234_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) HitPos::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__HitPosdict_234_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      HitPos::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__HitPosdict_234_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__HitPosdict_234_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HitPos::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__HitPosdict_234_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) HitPos::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__HitPosdict_234_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) HitPos::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__HitPosdict_234_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__HitPosdict_234_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__HitPosdict_234_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__HitPosdict_234_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static void G__setup_memvarHitPos(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__HitPosdictLN_TClass),G__defined_typename("atomic_TClass_ptr"),-2,4,"fgIsA=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
static void G__setup_memfuncHitPos(void) {
   ...
   G__memfunc_setup("HitPos",599,G__HitPosdict_234_0_1, 105, G__get_linked_tagnum(&G__HitPosdictLN_HitPos), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("HitPos",599,G__HitPosdict_234_0_2, 105, G__get_linked_tagnum(&G__HitPosdictLN_HitPos), -1, 0, 1, 1, 1, 0, "f - 'Float_t' 0 - random", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__HitPosdict_234_0_3, 85, G__get_linked_tagnum(&G__HitPosdictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&HitPos::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__HitPosdict_234_0_4, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HitPos::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__HitPosdict_234_0_5, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&HitPos::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__HitPosdict_234_0_6, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&HitPos::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__HitPosdict_234_0_10, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__HitPosdict_234_0_11, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HitPos::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__HitPosdict_234_0_12, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HitPos::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__HitPosdict_234_0_13, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&HitPos::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__HitPosdict_234_0_14, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&HitPos::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("HitPos", 599, G__HitPosdict_234_0_15, (int) ('i'), G__get_linked_tagnum(&G__HitPosdictLN_HitPos), -1, 0, 1, 1, 1, 0, "u 'HitPos' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~HitPos", 725, G__HitPosdict_234_0_16, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__HitPosdict_234_0_17, (int) ('u'), G__get_linked_tagnum(&G__HitPosdictLN_HitPos), -1, 1, 1, 1, 1, 0, "u 'HitPos' - 11 - -", (char*) NULL, (void*) NULL, 0);
